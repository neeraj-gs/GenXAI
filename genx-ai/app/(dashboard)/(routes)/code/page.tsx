...
const CodeXPage = () => {
  ...
  return (
    <div className="bg-gradient-to-r min-h-screen grainy from-rose-50 to-slate-100">
        <Heading
            title="CodeX-AI"
            description="Most Advanced AI Code generation model"
            icon={Code}
                ...
                <FormField name="prompt" render={({field})=>(
                    <FormItem className="col-span-12 lg:col-span-10">
                        <FormControl className="m-0 p-0 ">
                            <Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent p-4" disabled={isLoading} placeholder="What program do you want" {...field}/>
                        </FormControl>
                    </FormItem>
                )} />
